 ...
 * für eine im Routenplaner gewählte Adresse: alle Haltestellen im Umkreis zur Auswahl
 * anbieten statt nur automatisch auf die eine nächstgelegene abzubilden).
 */
