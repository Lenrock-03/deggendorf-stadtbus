...
import { activeServicesForWeekday, departuresForWeekday, nextDepartures } from "./calendar";
...
describe("activeServicesForWeekday", () => {
  it("liefert 'weekday' für Montag-Freitag", () => {
    for (const wd of [1, 2, 3, 4, 5]) {
      expect(activeServicesForWeekday(calendar, wd)).toEqual(["weekday"]);
    }
  });
