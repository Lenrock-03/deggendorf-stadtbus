...
import { addDays, dateInBerlin, nowMinutesInBerlin, parseTimeToMinutes } from "./time";
import { isPublicHoliday, isSchoolDay } from "./holidays";
 ...
 * Heiligabend/Silvester-Sonderregeln (siehe lib/holidays.ts):
